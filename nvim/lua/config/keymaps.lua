...
vim.keymap.set("n", "<leader>OF", ":ObsidianFollowLink<CR>", { desc = "Follow note reference under the cursor" })
vim.keymap.set("n", "<leader>OL", ":ObsidianBacklinks<CR>", { desc = "Open backlinks picker" })
