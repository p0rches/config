...
vim.keymap.set("n", "<C-n>", ":Neotree filesystem toggle left<CR>", {desc="Open explorer left"})
vim.keymap.set("n", "<leader>P", ":Neotree filesystem toggle current<CR>", {desc="Open explorer"})
